...
public class ReplyToStringTest {

    public static Collection<Object[]> messageParams() {
        return Arrays.asList(new Object[][] {
            {
                "name", 0.5f, "origem", "destino",
                "<Reply name=\"name\" prob=\"0.5\" source=\"origem\" target=\"destino\" />"
            },
            {
                "name", 1f, "node1", "node2",
                "<Reply name=\"name\" prob=\"1.0\" source=\"node1\" target=\"node2\" />"
            },
            {
                "name", 0f, "node1", "node2",
                "<Reply name=\"name\" prob=\"0.0\" source=\"node1\" target=\"node2\" />"
            }
        });
    }
    ...
    void testGetMessageToString(String name, Float prob, String sourceStr,
        ...
        Reply message = new Reply(name, prob, source, target);
